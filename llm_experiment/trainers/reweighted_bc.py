...
from trainers.reweighted_bc_trainer import ReweightedBCTrainer
...
flags.DEFINE_string('weighting_type', 'exp', 'the type of reweighting to use')
flags.DEFINE_boolean('clip_weighting', False, 'whether to use score scaling')
flags.DEFINE_float('clip_min', 0.0, 'the minimum value for score scaling')
flags.DEFINE_float('clip_max', 20.0, 'the maximum value for score scaling')
# flags for filtering
