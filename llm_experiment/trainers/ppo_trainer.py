...
from trainers.network_utils import PreTrainedModelWrapper, SUPPORTED_ARCHITECTURES
    ...
    def log_stats(
        ...
        if self.accelerator.is_main_process:
            ...
            if self.is_distributed:
                ...
                if true_rewards is not None:
                    dist.all_reduce(true_rewards, op=torch.distributed.ReduceOp.SUM)
                    true_rewards /= self.accelerator.num_processes
